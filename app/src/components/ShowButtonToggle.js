...
const ShowButtonToggle = ({ toggleGoster, goster }) => {
  ...
  return (
    <button
      ...
      className={` text-sm md:text-lg px-4 py-2 font-bold rounded flex items-center justify-center gap-2 ${goster ? "bg-green-900 text-white" : "bg-yellow-400 text-blue-900"
        }`}
    >
      {goster ? (
        <>
